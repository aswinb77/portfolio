...
export default function ProjectDetailModal({
  ...
  const caseStudies = {
    finmate: {
      navTitle: 'Finmate',
      eyebrow: 'LEAD PRODUCT DESIGNER · 2026 · LIVE ON APP STORE',
      heroTitle: 'Finmate.',
      ...
      previewTabs: [
        { label: 'Product Video', video: getMedia('/finny_product_video.mp4'), caption: 'Interactive Finny Onboarding & Expense Logging Demo' },
        { label: 'Onboarding', img: getMedia('/finmate-meet.png'), caption: 'Empathetic Dragon Companion Onboarding' },
        { label: 'Chat AI Logger', img: getMedia('/finmate-chat.png'), caption: 'Instant Natural Language & Chat Expense Logging' },
        { label: 'Habit Rings', img: getMedia('/finmate-story.png'), caption: 'Activity-Inspired Daily Expense Rings' },
      ],
      problem:
      ...
      decisions: [
        ...
        },
        {
          ...
          img: getMedia('/finmate-story.png'),
        },
      ],
    ...
    moviecc: {
      navTitle: 'Movie.cc',
      eyebrow: 'FULL-STACK & FLUTTER ARCHITECT · 2026 · ANDROID & CLOUD',
      heroTitle: 'Movie.cc.',
      subtitle: 'A full-stack Malayalam movie platform with automated data scraping (Wikipedia → TMDB → BookMyShow) maintaining 500+ records, serverless NLP fake-post detection, and live clustered chat.',
      githubUrl: 'https://github.com/aswinb77/moviecc',
      previewTabs: [
        { label: 'Movie Hub', img: getMedia('/moviecc-favorites.jpg'), caption: 'Curated Malayalam Movie Discovery & Real-Time Favorites' },
        { label: 'Verified News', img: getMedia('/moviecc-news.jpg'), caption: 'Automated 6-Hour Web Scraping Multi-Source Feed' },
        { label: 'Clustered Chat', img: getMedia('/moviecc-chat.jpg'), caption: 'Low-Latency Clustered Room (200 Users Per Node)' },
        { label: 'Splash Screen', img: getMedia('/moviecc-splash.jpg'), caption: 'Minimalist Cinematic Brand Identity' },
      ],
      problem:
        'Movie lovers and fans in the Malayalam cinema ecosystem struggle with scattered release schedules across disjointed platforms, unverified rumors/fake posts on social feeds, and lacking real-time discussion spaces.',
      approach:
        'I built a cross-platform Flutter/Dart app integrated with Firebase Auth and real-time Firestore sync. The backend runs an automated ingestion pipeline on Railway (Wikipedia → TMDB API → BookMyShow scraper) maintaining 500+ Malayalam movie records with zero manual intervention, combined with a serverless NLP heuristic engine to filter fake posts.',
      metrics: [
        { value: '500+', label: 'Malayalam Movies Synced' },
        { value: '0', label: 'Manual Catalog Updates' },
        { value: '200', label: 'Max Users Per Chat Cluster' },
        { value: '<10ms', label: 'Live Chat Delivery Latency' },
      ],
      decisions: [
        {
          num: '01',
          title: 'Automated 3-tier scraping pipeline (Wiki → TMDB → BMS)',
          desc: 'Built resilient scraping workers deployed on Railway targeting Wikipedia for initial film announcements, enriching with TMDB metadata, and scraping BookMyShow for real-time cinema release dates and booking links.',
          img: getMedia('/moviecc-news.jpg'),
        },
        {
          num: '02',
          title: 'Serverless NLP heuristics for fake-post moderation',
          desc: 'Implemented an automated content moderation pipeline analyzing submitted news and rumors against credible press feeds using NLP keyword matching and source validation, flagging unverified claims before publication.',
          img: getMedia('/moviecc-favorites.jpg'),
        },
        {
          num: '03',
          title: 'Cross-platform Flutter app with Firestore sync & Provider',
          desc: 'Engineered responsive Android/iOS UI with Provider state management, persistent offline caching, instant search, and real-time user ratings synchronized with Cloud Firestore.',
          img: getMedia('/moviecc-chat.jpg'),
        },
      ],
      techStack: ['Flutter', 'Dart', 'Node.js', 'Firebase Auth', 'Cloud Firestore', 'Puppeteer', 'Railway', 'NLP Heuristics'],
    },
    'design-system': {
    ...
    pmse: {
      navTitle: 'PMSE',
      eyebrow: 'EMBEDDED ML & SYSTEMS ENGINEER · 2025 · HARDWARE & SOFTWARE',
      heroTitle: 'PMSE.',
      ...
      previewTabs: [
        { label: 'System Demo', video: getMedia('/pmse.mp4'), caption: 'Embedded Sensor Telemetry & Real-Time Predictive Diagnostics', previewType: 'wide' },
        { label: 'EV Health', img: getMedia('/pmse-app-health.jpg'), caption: 'Flutter App: Real-Time Motor Temperature, Battery Voltage, Current & Vibration', previewType: 'phone' },
        { label: 'Charging Control', img: getMedia('/pmse-app-charging.jpg'), caption: 'Flutter App: Dynamic Voltage Limit Slider (Home 240V & Fast 400V)', previewType: 'phone' },
        { label: 'Stations', img: getMedia('/pmse-app-stations.jpg'), caption: 'Flutter App: Nearby Zeon EV Fast Charging Navigation & Slot Availability', previewType: 'phone' },
        { label: 'Sensor Testbench', img: getMedia('/pmse-sensor-setup.png'), caption: 'Hardware Sensor Wiring: Vibration, Temperature, Proximity, Current & Relay', previewType: 'wide', objectFit: 'contain' },
        { label: 'EV Schematic', img: getMedia('/pmse-ev-schematic.png'), caption: 'Hardware Sensor Placement across Motor Hub, Battery & Brakes', previewType: 'wide', objectFit: 'contain' },
      ],
      problem:
      ...
      decisions: [
        {
          ...
          img: getMedia('/pmse-hardware.jpg'),
          layoutType: 'wide',
          objectFit: 'contain',
        },
        {
          ...
          img: getMedia('/pmse-ev-schematic.png'),
          layoutType: 'wide',
          objectFit: 'contain',
        },
        {
          ...
          images: [
            getMedia('/pmse-app-health.jpg'),
            getMedia('/pmse-app-charging.jpg'),
            getMedia('/pmse-app-stations.jpg'),
          ],
        ...
        },
        {
          ...
          img: getMedia('/pmse-sensor-setup.png'),
          layoutType: 'wide',
          objectFit: 'contain',
        },
      ],
    ...
    jobseek: {
      navTitle: 'Jobseek Bot',
      eyebrow: 'AUTOMATION & BACKEND DEVELOPER · 2024 · TELEGRAM BOT',
      heroTitle: 'Jobseek Bot.',
      subtitle: 'An autonomous job notification engine scraping Kerala career boards with Puppeteer and delivering filtered, real-time alerts via Telegram Bot API.',
      githubUrl: 'https://github.com/aswinb77/jobseek-bot',
      coverType: 'branded',
      coverLabel: 'Jobseek Bot',
      coverSub: 'Automated Kerala Job Scraper & Telegram Notifier',
      coverBg: 'linear-gradient(135deg, #0b1a2e 0%, #0e294b 50%, #071220 100%)',
      coverAccent: '#38bdf8',
      coverBadge: 'Puppeteer · Node.js · Telegram API',
      previewTabs: [
        { label: 'Bot Alert Feed', img: getMedia('/jobseek-preview.jpg'), caption: 'Real-Time Job Notification Feed with One-Tap Apply Link and Region Tag', previewType: 'wide' },
      ],
      problem:
        'Job seekers across Kerala waste significant time manually refreshing fragmented local job boards, employment news portals, and company career pages, often missing tight application deadlines.',
      approach:
        'I built an automated scraping worker using Node.js and Puppeteer scheduled with node-cron. It continuously crawls regional Kerala employment portals, parses and cleans vacancy listings, dedupes postings, and instantly broadcasts categorized job alerts to Telegram subscribers.',
      metrics: [
        { value: '100%', label: 'Automated Job Aggregation' },
        { value: '0 sec', label: 'Instant Telegram Notification Delay' },
        { value: '14', label: 'Kerala Districts Covered' },
        { value: '24/7', label: 'Scheduled Cron Uptime' },
      ],
      decisions: [
        {
          num: '01',
          title: 'Headless Puppeteer scraping with DOM mutation resilience',
          desc: 'Engineered robust Puppeteer scraping routines that handle dynamic JavaScript-rendered career boards, bypass anti-bot challenges gracefully, and extract structured metadata: job role, company, location, experience requirements, and direct application URLs.',
          img: getMedia('/jobseek-preview.jpg'),
          layoutType: 'wide',
        },
        {
          num: '02',
          title: 'Regional and category filtering pipeline',
          desc: 'Parsed vacancy descriptions to extract district names (Ernakulam, Thiruvananthapuram, Kozhikode, etc.) and industry tags, allowing subscribers to filter notifications and receive only relevant openings.',
        },
        {
          num: '03',
          title: 'Persistent deduplication & instant Telegram Bot dispatch',
          desc: 'Maintained a hashed registry of seen job IDs and posting timestamps to ensure zero duplicate alerts. New vacancies format into Markdown message cards with inline "Apply Now" buttons delivered instantly via Telegram Bot API.',
        },
      ],
      techStack: ['Node.js', 'Puppeteer', 'Telegram Bot API', 'node-cron', 'JavaScript', 'Cheerio', 'Railway'],
    },
    avwallet: {
      navTitle: 'AV Wallet',
      eyebrow: 'FULL-STACK DEVELOPER · 2023 · MOBILE WEB',
      heroTitle: 'AV Wallet.',
      ...
      previewTabs: [
        { label: 'Wallet Dashboard', img: getMedia('/avwallet-dashboard.png'), caption: 'User Wallet: Balance Card, Lazy-loaded Paginated Transactions & Withdraw Flow', previewType: 'phone' },
        { label: 'Merchant Panel', img: getMedia('/avwallet-merchant.png'), caption: 'Merchant Dashboard: Balance, Recharge/Payout Stats, Payment Token & API Endpoint', previewType: 'phone' },
        { label: 'Add Fund (UPI)', img: getMedia('/avwallet-recharge.png'), caption: 'Recharge via UPI QR Code — Admin-approved via Telegram Bot', previewType: 'phone' },
        { label: 'Transaction Detail', img: getMedia('/avwallet-txdetail.png'), caption: 'Transaction Detail Modal: Type, Status, Method, Reference ID', previewType: 'phone' },
      ],
      problem:
      ...
      decisions: [
        {
          ...
          images: [getMedia('/avwallet-dashboard.png'), getMedia('/avwallet-merchant.png')],
        ...
        },
        {
          ...
          img: getMedia('/avwallet-txdetail.png'),
          layoutType: 'phone',
        },
        {
          num: '03',
        ...
        },
        {
          ...
          img: getMedia('/avwallet-recharge.png'),
          layoutType: 'phone',
        },
      ],
      ...
      previewTabs: [
        {
          ...
          img: getMedia('/kalavasta-screen.png'),
        ...
        },
        {
          ...
          img: getMedia('/kalavasta-mobile.png'),
          ...
          <div className="pdm-topbar__actions">
            ...
            {study.githubUrl && (
              ...
              >
                ...
                <span className="pdm-topbar__github-text">GitHub</span>
                <span className="pdm-topbar__arrow">↗</span>
              </a>
            )}
            <span className="pdm-topbar__divider pdm-topbar__divider--gh">/</span>
            ...
            >
              <span className="pdm-topbar__nav-text">← Prev</span>
              <span className="pdm-topbar__nav-icon" aria-hidden="true">‹</span>
            </button>
            ...
            >
              <span className="pdm-topbar__nav-text">Next →</span>
              <span className="pdm-topbar__nav-icon" aria-hidden="true">›</span>
            </button>
